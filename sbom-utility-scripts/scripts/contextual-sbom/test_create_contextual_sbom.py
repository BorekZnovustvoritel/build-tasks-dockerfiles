...
from create_contextual_sbom import get_base_images, get_parent_image, identify_arch, use_contextual_sbom_creation
...
@pytest.mark.parametrize(
    ...
    [("parent_sbom.spdx.json", True), ("parent_sbom.cdx.json", False), ("nonexistent_file.json", False)],
)
def test_use_contextual_sbom_creation(sbom_name: str, expected_output: bool):
    ...
    assert use_contextual_sbom_creation(path_to_file) == expected_output
